...
/*
    ...
    Simple Image Manipulation (convolution example)

    http://scratchapixel.com/lessons/2d-image-processing/simple-image-manipulations/
    ...
    clang++ -o image -O3 image.cpp -std=c++0x -stdlib=libc++
